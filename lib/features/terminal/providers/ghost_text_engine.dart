/// Moteur de suggestions Ghost Text pour l'auto-complétion.
///
/// Fournit des suggestions de commandes basées sur :
/// 1. L'historique de l'utilisateur (priorité)
/// 2. Une base de données de commandes courantes
class GhostTextEngine {
  /// Retourne une suggestion pour compléter l'input courant.
  ///
  ...
  /// Base de commandes complètes (triées par fréquence/importance).
