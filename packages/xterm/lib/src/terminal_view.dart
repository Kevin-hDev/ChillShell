...
class TerminalView extends StatefulWidget {
  ...
  /// When true, the terminal only grows (never shrinks in height).
  /// Prevents content loss when the viewport temporarily shrinks.
  final bool growOnlyResize;
    ...
    Widget child = Scrollable(
      ...
      viewportBuilder: (context, offset) {
        return _TerminalView(
          ...
          growOnlyResize: widget.growOnlyResize,
